<?php
$connection = mysql_connect("sql9.freesqldatabase.com:3306", "root", ""); // Establishing connection with server..
$db = mysql_select_db("sql9375583", $connection); // Selecting Database.
