...
<body>
	...
	<div id="add_left_padding">
		<!--Header-->
		<ion-header-bar>
			<a href="https://edgewood.sredgewoodhelpers.org"><button>Back to stable release</button></a><br><a href="lrs/login.php"><button id="login_button">Login (WORK IN PROGRESS)</button></a>
			<h3 class="allhthrees">
				Please <a href="/Donate.html">Donate</a>; Remember we are a ALL Non-Profit Orginaization<br><br>
